...
const TopNav = () => {
    ...
    return (
        <div className="max-w-[1520px] mx-auto flex justify-between items-center p-4">
            <div className="flex items-center">
                ...
                <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
                    Joung's <span className="font-bold">요리교실</span>
                </h1>
        ...
        <button className="bg-amber-900 text-white hidden md:flex items-center py-2 rounded-full">
        ...
        >
            ...
            <h2 className="text-2xl p-4">Joung's <span className="text-amber-900 font-bold">요리교실</span></h2>
            <nav>
